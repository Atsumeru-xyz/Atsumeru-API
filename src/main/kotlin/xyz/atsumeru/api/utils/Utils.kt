...
fun startsWithIgnoreCase(first: String, second: String): Boolean {
    return isNotEmpty(first) && isNotEmpty(second) && first.lowercase().startsWith(second.lowercase())
}
...
fun File.asProgressRequestBody(
    ...
    return object : RequestBody() {
        ...
        override fun writeTo(sink: BufferedSink) {
            this@asProgressRequestBody.source().use { fileSource ->
                val progressSource = object : ForwardingSource(fileSource) {
                    ...
                    override fun read(sink: okio.Buffer, byteCount: Long): Long {
                        ...
                        if (bytesRead != -1L) {
                            ...
                            if (totalLength > 0) {
                                progressListener.onProgress(totalBytesRead.toFloat() / totalLength)
                            }
                        }
                        return bytesRead
                    }
